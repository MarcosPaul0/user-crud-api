// <copyright file="EnvironmentVariablesService.cs" company="PlaceholderCompany">
...
public class EnvironmentVariablesService : IEnvironmentVariablesService
{
    ...
    public string ResendApiKey { get; private set; } = GetRequiredAndConvert<string>("RESEND_API_KEY");

    public string ResendFromEmail { get; private set; } = GetRequiredAndConvert<string>("RESEND_FROM_EMAIL");

    public string AbacatePayApiKey { get; private set; } = GetRequiredAndConvert<string>("ABACATE_PAY_API_KEY");

    public string AbacatePayWebhookSecret { get; private set; } = GetRequiredAndConvert<string>("ABACATE_PAY_WEBHOOK_SECRET");

    public string AbacatePayWebhookPublicKey { get; private set; } = GetRequiredAndConvert<string>("ABACATE_PAY_WEBHOOK_PUBLIC_KEY");
